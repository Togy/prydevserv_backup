...
class hell_telenpc : public CreatureScript
{
    public:
        ...
        hell_telenpc()
            : CreatureScript("npc_teleportguy")
        {
        }
...
bool OnGossipHello(Player* player, Creature* creature)
{
	...
	{
		player->ADD_GOSSIP_ITEM( 7, "[Cities]"             			, GOSSIP_SENDER_MAIN , 1000);
		player->ADD_GOSSIP_ITEM( 7, "[Arenas]"             			, GOSSIP_SENDER_MAIN , 3000);
		player->ADD_GOSSIP_ITEM( 7, "[Instances Zones]"        		, GOSSIP_SENDER_MAIN , 3800);
	}
	else // Main Menu for Horde
	{
		player->ADD_GOSSIP_ITEM( 7, "[Cities]"                		, GOSSIP_SENDER_MAIN , 2000);
		player->ADD_GOSSIP_ITEM( 7, "[Arenas]"              		, GOSSIP_SENDER_MAIN , 3000);
		player->ADD_GOSSIP_ITEM( 7, "[Instances Zones]"        		, GOSSIP_SENDER_MAIN , 3800);
	}
...
case 1000: //Cities - Alliance
		...
		player->ADD_GOSSIP_ITEM( 5, "Shattrath City"               , GOSSIP_SENDER_MAIN , 3035);
		player->ADD_GOSSIP_ITEM( 5, "Dalaran City"                 , GOSSIP_SENDER_MAIN , 3010);
		player->ADD_GOSSIP_ITEM( 5, "Booty Bay"                    , GOSSIP_SENDER_MAIN , 3005);
		player->ADD_GOSSIP_ITEM( 5, "Gadegetzan"                   , GOSSIP_SENDER_MAIN , 3020);
		player->ADD_GOSSIP_ITEM( 5, "Isle Of Quel'Danas"           , GOSSIP_SENDER_MAIN , 3040);
...
case 2000: //Cities - Horde
		...
		player->ADD_GOSSIP_ITEM( 5, "Badlands"                     , GOSSIP_SENDER_MAIN , 2020);
		player->ADD_GOSSIP_ITEM( 5, "Shattrath City"               , GOSSIP_SENDER_MAIN , 3035);
		player->ADD_GOSSIP_ITEM( 5, "Dalaran City"                 , GOSSIP_SENDER_MAIN , 3010);
		player->ADD_GOSSIP_ITEM( 5, "Booty Bay"                    , GOSSIP_SENDER_MAIN , 3005);
		player->ADD_GOSSIP_ITEM( 5, "Gadegetzan"                   , GOSSIP_SENDER_MAIN , 3020);
...
case 3000: //Arenas
		player->ADD_GOSSIP_ITEM( 5, "Gurubashi Arena"               , GOSSIP_SENDER_MAIN , 8000);
		player->ADD_GOSSIP_ITEM( 5, "The Maul"              		, GOSSIP_SENDER_MAIN , 7999);
		player->ADD_GOSSIP_ITEM( 7, "<-- Main Menu"                 , GOSSIP_SENDER_MAIN , 5005);
...
case 3800: //Instances Zones
	player->ADD_GOSSIP_ITEM( 5, "[Kalimandor Instances]"           , GOSSIP_SENDER_MAIN , 5010);
	player->ADD_GOSSIP_ITEM( 5, "[Eastern Kingdoms Instances]"     , GOSSIP_SENDER_MAIN , 5015);
	player->ADD_GOSSIP_ITEM( 5, "[Outland Instances]"              , GOSSIP_SENDER_MAIN , 5025);
	player->ADD_GOSSIP_ITEM( 5, "[Northrend Instances]"            , GOSSIP_SENDER_MAIN , 5030);
	player->ADD_GOSSIP_ITEM( 7, "<-- Main Menu"                    , GOSSIP_SENDER_MAIN , 5005);
...
case 5010: //Kalimdor
	player->ADD_GOSSIP_ITEM( 5, "Blackfathom Deeps"                , GOSSIP_SENDER_MAIN , 6001);
	player->ADD_GOSSIP_ITEM( 5, "Caverns of Time"                  , GOSSIP_SENDER_MAIN , 6005);
	player->ADD_GOSSIP_ITEM( 5, "Dire Maul"                        , GOSSIP_SENDER_MAIN , 6010);
	player->ADD_GOSSIP_ITEM( 5, "Maraudon"                         , GOSSIP_SENDER_MAIN , 6015);
	player->ADD_GOSSIP_ITEM( 5, "Ragefire Chasm"                   , GOSSIP_SENDER_MAIN , 6020);
	player->ADD_GOSSIP_ITEM( 5, "Razorfen Downs"                   , GOSSIP_SENDER_MAIN , 6025);
	player->ADD_GOSSIP_ITEM( 5, "Razorfen Kraul"                   , GOSSIP_SENDER_MAIN , 6030);
	player->ADD_GOSSIP_ITEM( 5, "Ruins of Ahn'Qiraj"               , GOSSIP_SENDER_MAIN , 6035);
	player->ADD_GOSSIP_ITEM( 5, "Temple of Ahn'Qiraj"              , GOSSIP_SENDER_MAIN , 6040);
	player->ADD_GOSSIP_ITEM( 5, "Wailing Caverns"                  , GOSSIP_SENDER_MAIN , 6045);
	player->ADD_GOSSIP_ITEM( 5, "Zul'Farrak"                       , GOSSIP_SENDER_MAIN , 6050);
	player->ADD_GOSSIP_ITEM( 7, "<-- Back"         				   , GOSSIP_SENDER_MAIN , 3800);
	player->ADD_GOSSIP_ITEM( 7, "<-- Main Menu"                    , GOSSIP_SENDER_MAIN , 5005);
...
case 5015: //Eastern Kingdoms 1
	player->ADD_GOSSIP_ITEM( 5, "Blackrock Depths"                 , GOSSIP_SENDER_MAIN , 7001);
	player->ADD_GOSSIP_ITEM( 5, "Blackrock Spire"                  , GOSSIP_SENDER_MAIN , 7005);
	player->ADD_GOSSIP_ITEM( 5, "Blackwing Lair"                   , GOSSIP_SENDER_MAIN , 7010);
	player->ADD_GOSSIP_ITEM( 5, "Deadmines"                        , GOSSIP_SENDER_MAIN , 7015);
	player->ADD_GOSSIP_ITEM( 5, "Gnomeregan"                       , GOSSIP_SENDER_MAIN , 7020);
	player->ADD_GOSSIP_ITEM( 5, "Isle Of Quel'Danas"               , GOSSIP_SENDER_MAIN , 7025);
	player->ADD_GOSSIP_ITEM( 5, "Karazhan"                         , GOSSIP_SENDER_MAIN , 7030);
	player->ADD_GOSSIP_ITEM( 5, "Molten Core"                      , GOSSIP_SENDER_MAIN , 7035);
	player->ADD_GOSSIP_ITEM( 7, "Page 2 -->"                       , GOSSIP_SENDER_MAIN , 5020);
	player->ADD_GOSSIP_ITEM( 7, "<-- Back"                         , GOSSIP_SENDER_MAIN , 3800);
...
case 5020: //Eastern Kingdoms 2
	player->ADD_GOSSIP_ITEM( 5, "Scarlet Monastery"                , GOSSIP_SENDER_MAIN , 7040);
	player->ADD_GOSSIP_ITEM( 5, "Scholomance"                      , GOSSIP_SENDER_MAIN , 7045);
	player->ADD_GOSSIP_ITEM( 5, "Shadowfang Keep"                  , GOSSIP_SENDER_MAIN , 7050);
	player->ADD_GOSSIP_ITEM( 5, "Stratholme"                       , GOSSIP_SENDER_MAIN , 7055);
	player->ADD_GOSSIP_ITEM( 5, "Sunken Temple"                    , GOSSIP_SENDER_MAIN , 7060);
	player->ADD_GOSSIP_ITEM( 5, "The Stockade"                     , GOSSIP_SENDER_MAIN , 7065);
	...
	player->ADD_GOSSIP_ITEM( 7, "<-- Page 1"                       , GOSSIP_SENDER_MAIN , 5015);
	player->ADD_GOSSIP_ITEM( 7, "<-- Main Menu"                    , GOSSIP_SENDER_MAIN , 5005);
...
case 5030: //Northrend
	...
	player->ADD_GOSSIP_ITEM( 5, "Onyxia's Lair"                    , GOSSIP_SENDER_MAIN , 9030);
	player->ADD_GOSSIP_ITEM( 5, "The Nexus"                        , GOSSIP_SENDER_MAIN , 9035);
	player->ADD_GOSSIP_ITEM( 5, "The Obsidian Sanctum"             , GOSSIP_SENDER_MAIN , 9040);
	player->ADD_GOSSIP_ITEM( 5, "Utgarde Keep"                     , GOSSIP_SENDER_MAIN , 9045);
	player->ADD_GOSSIP_ITEM( 5, "Utgarde Pinnacle"                 , GOSSIP_SENDER_MAIN , 9050);
	player->ADD_GOSSIP_ITEM( 5, "Ulduar"                           , GOSSIP_SENDER_MAIN , 9055);
	player->ADD_GOSSIP_ITEM( 5, "Violet Hold"                      , GOSSIP_SENDER_MAIN , 9060);
	player->ADD_GOSSIP_ITEM( 7, "<-- Back"                         , GOSSIP_SENDER_MAIN , 3800);
	player->ADD_GOSSIP_ITEM( 7, "<-- Main Menu"                    , GOSSIP_SENDER_MAIN , 5005);
...
case 8000:// Gurubashi Arena
	player->CLOSE_GOSSIP_MENU();
	player->TeleportTo(0, -13266.0048f, 158.5045f, 35.8074f, 1.0747f);
break;

case 7999:// The Maul
	player->CLOSE_GOSSIP_MENU();
	player->TeleportTo(1, -3778.5642f, 1087.3159f, 131.9688f, 0.0142f);
break;
