        ...
        struct boss_lady_deathwhisperAI : public BossAI
        {
            ...
            void UpdateAI(const uint32 uiDiff)
            {
                if (m_uiIntroTimer <= uiDiff && bIntro && m_uiIntroPhase < 7)
                {
                    ...
                    {
                        case 1: DoScriptText(SAY_INTRO_2, me); m_uiIntroTimer = 11000; break;
                        case 2: DoScriptText(SAY_INTRO_3, me); m_uiIntroTimer = 8000;  break;
                        case 3: DoScriptText(SAY_INTRO_4, me); m_uiIntroTimer = 13000; break;
                        case 4: DoScriptText(SAY_INTRO_5, me); m_uiIntroTimer = 8000;  break;
                        case 5: DoScriptText(SAY_INTRO_6, me); m_uiIntroTimer = 12000; break;
