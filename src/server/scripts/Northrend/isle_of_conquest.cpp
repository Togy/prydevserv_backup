        ...
        struct npc_four_car_garageAI : public NullCreatureAI
        {
            ...
            void PassengerBoarded(Unit* who, int8 seatId, bool apply)
            {
                if (apply)
                {
                    ...
                    switch(me->GetEntry())
                    {
                        case BG_IC_NPCID_DEMOLISHER:
                            spellId = 68365;
                            break;
                        case BG_IC_NPCID_GLAIVE_THROWER_A:
                        case BG_IC_NPCID_GLAIVE_THROWER_H:
                            spellId = 68363;
                            break;
                        case BG_IC_NPCID_SIEGE_ENGINE_H:
                        case BG_IC_NPCID_SIEGE_ENGINE_A:
                            spellId = 68364;
                            break;
                        case BG_IC_NPCID_CATAPULT:
                            spellId = 68362;
                            break;
                        default:
                            return;
